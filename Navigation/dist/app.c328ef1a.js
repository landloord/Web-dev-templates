...
var navPopup = document.querySelector(".sub-services");
var navList = document.querySelectorAll(".nav-items");
...
navList.forEach(function (item) {
  item.addEventListener("click", function (event) {
    var _iterator = _createForOfIteratorHelper(navList),
        _step;
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (item.classList.contains("list")) {
          ...
          navPopup.addEventListener("mouseout", function () {
            setTimeout(function () {
